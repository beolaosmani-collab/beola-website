...
export const SITE = {
  ...
  i18n: {
    sq: {
      ...
      c_products: "Produktet", c_headline: "Gjeni pajisjen e duhur",
      c_intro: "Shfletoni përzgjedhjen tonë aktuale të elektroshtëpiakeve gjermane. Stoku ndryshon rregullisht — na kontaktoni për të konfirmuar disponueshmërinë.",
      c_search_ph: "Kërko Miele, Bosch, lavatriçe…",
      c_filters: "Filtra", c_sort: "Rendit sipas", c_clear: "Pastro filtrat", c_apply: "Shfaq rezultatet", c_close: "Mbyll",
      c_f_category: "Kategoria", c_f_brand: "Marka", c_f_avail: "Disponueshmëria", c_f_branch: "Dega",
      c_sort_new: "Më të rejat", c_sort_az: "Marka A–Z", c_sort_za: "Marka Z–A",
      c_count: "pajisje", c_none_title: "Asnjë pajisje nuk përputhet me filtrat.", c_none_sub: "Provoni të hiqni një filtër ose na pyesni për të reja.",
      c_view: "Shiko produktin", c_ask_price: "Pyet për çmimin", c_ask_wa: "Pyet në WhatsApp",
      c_save: "Ruaj", c_saved: "Të ruajtura", c_saved_title: "Pajisjet e ruajtura", c_saved_empty: "Nuk keni ruajtur ende asnjë pajisje.", c_browse: "Shfleto produktet",
      c_related: "Pajisje të ngjashme", c_specs: "Specifikimet",
      c_price_label: "Çmimi", c_model_label: "Modeli", c_branch_at: "Në dispozicion te", c_share: "Ndaje", c_copied: "Lidhja u kopjua",
      c_view_all: "Shiko të gjitha të rejat",
      c_wa_product: "Përshëndetje B.O. BEOLA, më intereson kjo pajisje. A është ende e disponueshme dhe sa kushton?",
    ...
    en: {
      ...
      c_products: "Products", c_headline: "Find the right appliance",
      c_intro: "Browse our current selection of German household appliances. Stock changes regularly, so contact us to confirm availability.",
      c_search_ph: "Search Miele, Bosch, washing machines…",
      c_filters: "Filters", c_sort: "Sort by", c_clear: "Clear filters", c_apply: "Show results", c_close: "Close",
      c_f_category: "Category", c_f_brand: "Brand", c_f_avail: "Availability", c_f_branch: "Branch",
      c_sort_new: "Newest", c_sort_az: "Brand A–Z", c_sort_za: "Brand Z–A",
      c_count: "appliances", c_none_title: "No appliances match your filters.", c_none_sub: "Try removing a filter or ask us about new arrivals.",
      c_view: "View product", c_ask_price: "Ask for price", c_ask_wa: "Ask on WhatsApp",
      c_save: "Save", c_saved: "Saved", c_saved_title: "Saved appliances", c_saved_empty: "You haven't saved any appliances yet.", c_browse: "Browse products",
      c_related: "Similar appliances", c_specs: "Specifications",
      c_price_label: "Price", c_model_label: "Model", c_branch_at: "Available at", c_share: "Share", c_copied: "Link copied",
      c_view_all: "View all new arrivals",
      c_wa_product: "Hello B.O. BEOLA, I'm interested in this appliance. Is it still available and what is the price?",
    ...
    de: {
      ...
      c_products: "Produkte", c_headline: "Finden Sie das richtige Gerät",
      c_intro: "Stöbern Sie in unserer aktuellen Auswahl deutscher Haushaltsgeräte. Der Bestand wechselt regelmäßig — kontaktieren Sie uns zur Verfügbarkeit.",
      c_search_ph: "Miele, Bosch, Waschmaschinen suchen…",
      c_filters: "Filter", c_sort: "Sortieren", c_clear: "Filter löschen", c_apply: "Ergebnisse anzeigen", c_close: "Schließen",
      c_f_category: "Kategorie", c_f_brand: "Marke", c_f_avail: "Verfügbarkeit", c_f_branch: "Filiale",
      c_sort_new: "Neueste", c_sort_az: "Marke A–Z", c_sort_za: "Marke Z–A",
      c_count: "Geräte", c_none_title: "Keine Geräte entsprechen Ihren Filtern.", c_none_sub: "Entfernen Sie einen Filter oder fragen Sie nach Neuheiten.",
      c_view: "Gerät ansehen", c_ask_price: "Preis anfragen", c_ask_wa: "Auf WhatsApp fragen",
      c_save: "Merken", c_saved: "Gemerkt", c_saved_title: "Gemerkte Geräte", c_saved_empty: "Sie haben noch keine Geräte gemerkt.", c_browse: "Produkte ansehen",
      c_related: "Ähnliche Geräte", c_specs: "Technische Daten",
      c_price_label: "Preis", c_model_label: "Modell", c_branch_at: "Verfügbar in", c_share: "Teilen", c_copied: "Link kopiert",
      c_view_all: "Alle Neuheiten ansehen",
      c_wa_product: "Hallo B.O. BEOLA, ich interessiere mich für dieses Gerät. Ist es noch verfügbar und was kostet es?",
